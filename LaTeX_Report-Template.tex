...
\begin{document}
	...
	\begin{figure}[t!]
		...
		\begin{subfigure}{1.\linewidth}
			\centering
			\includegraphics[width=0.9\linewidth]{Icons/SJTU_1.png}
		...
		\begin{subfigure}{1.\linewidth}
			\centering
			\includegraphics[width=0.9\linewidth]{Icons/SJTU_2.png}
			%\caption{A red flower.}
		\end{subfigure}
		\vspace{0.1em}%\vfill
		...
		\begin{subfigure}{.5\linewidth}
			\centering
			\includegraphics[width=.7\linewidth]{Icons/SJTU_3.png}
